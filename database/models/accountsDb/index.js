 ...
 */
const AppMenuMasterModel =
  require('./tables/AppMenuMaster.model')(
    accountsDbSequilizeInstance
  );
const OrgAppMenuMappingModel =
  require('./tables/OrgAppMenuMapping.model')(
    accountsDbSequilizeInstance);
const OrgUserAppMenuMapping =
  require('./tables/OrgUserAppMenuMapping.model')(
    accountsDbSequilizeInstance
  );
const OrgRoleMenuMapping =
  require('./tables/OrgRoleMenuMapping.model')(
    accountsDbSequilizeInstance
  );
